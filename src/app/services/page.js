...
export const metadata = {
  title: "Services — 14U Capital",
  description:
    "14U Capital offers end-to-end fundraising, collateral documentation, M&A advisory, and operations as a service for early-stage founders.",
};
        ...
        <section className="relative pt-28 pb-16 bg-[#fbf6f3] overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
            <div className="flex items-center justify-center space-x-4 mb-6">
              ...
              <span className="text-xs font-bold text-brand-pink uppercase tracking-[0.3em]">What We Do</span>
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold text-[#0B132B] tracking-tight mb-6">
              How We Work <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-brand-pink">With Founders.</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed font-medium">
              Highly focused advisory services designed to convert opportunities into definitive outcomes.
            </p>
          </div>
        </section>
